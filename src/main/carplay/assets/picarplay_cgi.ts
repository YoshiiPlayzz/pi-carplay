export const buildServerCgiScript = (): string =>
  [
    ...
    '',
    '# pi-carplay helper CGI',
    '',
    'header() {',
    '  printf "Content-type: text/html\\r\\n\\r\\n"',
    '  echo "<!DOCTYPE html>"',
    '  echo "<html><head><meta charset=\\"utf-8\\"><title>pi-carplay tools</title>"',
    ...
    'show_index() {',
    '  header',
    '  echo "<h1>pi-carplay / riddle tools</h1>"',
    '  echo "<p class=\\"muted\\">This CGI runs directly on the dongle and has been replaced by pi-carplay.</p>"',
    '  echo "<ul>"',
